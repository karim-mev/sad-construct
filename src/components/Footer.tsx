  ...
  return (
    <div>
      <div className="flex bg-gray-100 text-gray-600 items-center justify-between px-8 py-10">
        ...
        <div className="flex flex-wrap text-xs sm:text-base gap-4 items-center justify-center flex-1">
          <div className="">
        ...
        <div className="flex flex-1 gap-6">
          <div className="flex items-center justify-end gap-6 flex-1">
            {/* <Snapchat />
          <Instagram /> */}
            <Link href="mailto:projects@sadeemconst.com">
              <Mail />
            </Link>
          </div>
        </div>
      ...
      <div className="bg-gray-300 text-center p-4">
        المملكة العربية السعودية - جدة - شارع صاري - مركز صاري المطور Kingdom of
        Saudi Arabia - Jeddah - Sari Street - Sari Developer Center
      </div>
    </div>
  );
}
